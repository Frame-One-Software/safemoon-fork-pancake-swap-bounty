...
**    Total tax - 10%
**
**    2% - Reflexion/rewards. To be distributed equally amongst all holders of Token only on selling of Token tokens and not on wallet to wallet transfers.
**
**    2% - Burned.  Sent directly to the burn address as Token. This burn function will stop when total supply of Token = 100 trillion.  Tax will now total only 8% as of that point.
**
**    2% - Marketing.  This will be sent straight to the tax generated marketing wallet as Token.
**
**    2% - Charity - this will be sent to a charity wallet as Token
**
...
contract Token_Adjusted  is Context, IERC20, Ownable {
...
//    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    ...
    uint256 private _burnAt = 1623412800;      // Friday, 11 June 2021 12:00:00
    ...
    constructor (string memory name, string memory symbol, address uniswapV2RouterAddress, address charityWallet, address marketingWallet, uint256 totalSupply) public {
    ...
    // based on feedback from Ariel Ortmann, this was changed from the original.
