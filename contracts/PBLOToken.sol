...
**    Total tax - 10%
**
**    2% - Reflexion/rewards. To be distributed equally amongst all holders of PBLO only on selling of PBLO tokens and not on wallet to wallet transfers.
**
...
**
**    2% - Marketing.  This will be sent straight to the tax generated marketing wallet as PBLO.
**
**    2% - Charity - this will be sent to a charity wallet as PBLO
**
...
contract PBLOToken  is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 957599988555015698822310480664145;   // TOTAL SUPPLY 5th JUNE
    ...
    // editted from orginal code provided to include the v2router in the constructor
    constructor (address charityWallet, address marketingWallet, address burnWallet, address uniswapV2RouterAddress) public {
    ...
    function changeCharityWallet(address charityWallet) external onlyOwner() {
        _charityWallet = charityWallet;
    }

    function changeMarkettingWallet(address marketingWallet) external onlyOwner() {
        _marketingWallet = marketingWallet;
    }

    function changeBurnWallet(address burnWallet) external onlyOwner() {
        _burnWallet = burnWallet;
    }
    ...
    function _transfer(
            ...
            && _rOwned[owner()] > burnTokenEveryWeek )
        {
            ...
            _rTotal = _rTotal.sub(burnTokenEveryWeek);

            _rOwned[_burnWallet] = _rOwned[_burnWallet].sub(burnTokenEveryWeek);
            _tOwned[_burnWallet] = _tOwned[_burnWallet].sub(burnTokenEveryWeek);
